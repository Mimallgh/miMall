...
const Nav = () => {
  return (
    <>
      <header>
        {/* To sell on the site */}
        <div className="sell text-1xl">
          <Link href="/sell">Sell on MiMall</Link>
        </div>

        <nav className="h-[5rem] z-20 mt-8 top-0 fixed w-screen shadow-md  bg-green-600 px-4 hidden md:flex justify-between items-center">
          <Link
            href="/"
